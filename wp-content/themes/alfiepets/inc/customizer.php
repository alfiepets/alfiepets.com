	...
	get_current_screen()->add_help_tab( array(
		...
		'content' =>
			'<ul>' .
				...
				'<li>' . sprintf( __( 'For an in-depth tutorial, and more tips and tricks, visit the <a href="%s">Twenty Fourteen documentation</a>.', 'twentyfourteen' ), 'http://codex.wordpress.org/Alfiepets' ) . '</li>' .
			'</ul>',
	) );
}
